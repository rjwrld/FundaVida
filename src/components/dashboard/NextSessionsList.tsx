          ...
          {sessions.map((session) => (
            ...
            >
              ...
              <Link
                ...
                className="shrink-0 inline-flex items-center gap-1 rounded-md bg-brand-green-500 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-brand-green-600"
              >
